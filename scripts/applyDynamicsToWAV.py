...
if __name__ == "__main__":
    ...
    parser.add_argument("--pppp", default='0.5', help="value for dynamic pppp, between 0.0 and 1.0, default is 0.5")
    parser.add_argument("--ppp", default='0.5', help="value for dynamic ppp, between 0.0 and 1.0, default is 0.5")
    parser.add_argument("--pp", default='0.5', help="value for dynamic pp, between 0.0 and 1.0, default is 0.5")
    parser.add_argument("--p", default='0.5', help="value for dynamic p, between 0.0 and 1.0, default is 0.5")
    parser.add_argument("--mp", default='0.65', help="value for dynamic mp, between 0.0 and 1.0, default is 0.65")
    parser.add_argument("--n", default='0.75', help="value for dynamic n, between 0.0 and 1.0, default is 0.75")
    parser.add_argument("--mf", default='0.85', help="value for dynamic mf, between 0.0 and 1.0, default is 0.85")
    parser.add_argument("--f", default='1.0', help="value for dynamic f, between 0.0 and 1.0, default is 1.0")
    parser.add_argument("--ff", default='1.0', help="value for dynamic ff, between 0.0 and 1.0, default is 1.0")
